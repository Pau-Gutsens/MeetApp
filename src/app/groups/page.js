    ...
    return (
        <div className="min-h-screen bg-gray-50 relative p-6 font-sans">
            ...
            <div className="max-w-4xl mx-auto pt-16">
                ...
                {/* Back Link (only if not in list view, or always to dashboard if in list view) */}
                {view !== 'list' && (
                    ...
                    <>
                        <div className="flex justify-between items-end mb-8">
                            <div>
                                ...
                                <p className="text-gray-500 font-medium mt-2">Quedadas activas</p>
                            </div>
                            <button
                            ...
                            <div>
                                ...
                                <div className="flex -space-x-2 overflow-hidden">
                                    {participants.map((p, i) => (
                                        <div key={i} className="inline-block h-8 w-8 rounded-full ring-2 ring-white bg-indigo-100 flex items-center justify-center text-xs font-bold text-indigo-800" title={p.Usuario.email}>
